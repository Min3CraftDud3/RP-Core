...
/**
 * Created by Min3 on 10/22/2014.
 *
 Paste report = new Paste("Header");
 report.appendLine("line1").appendLine("Line2");

 plugin.getReporter.post("Name of report",report,ReportFormat.YAML,ExpireDate.ONE_MONTH);
 */
import java.io.*;
